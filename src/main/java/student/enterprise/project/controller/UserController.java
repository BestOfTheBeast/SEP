...
public class UserController {
  ...
  @GetMapping("{id}")
  UserDTO get(@PathVariable Long userId)  { return userService.get(userId); }
  ...
  @PutMapping
  UserDTO updateUser(@RequestBody UserDTO userToUpdate) { return userService.update(userToUpdate); }
